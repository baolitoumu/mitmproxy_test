...
class TestDBHelper():
    ...
    def testCreateTable(self):
        sql="create table 430xianyuopen(id int primary key auto_increment,city_code int(10),city_name varchar(200), city_name_province varchar(200), city_url varchar(200), currPage int(10), district varchar(200), district_url varchar(200),ershou varchar(200),ershouCount varchar(200),final_url varchar(200),firstlevel_title varchar(200),firstlevel_url varchar(200),idleCount varchar(200),item_From varchar(200),item_FromDesc varchar(200),item_FromTarget varchar(200),item_Url varchar(200),item_collectCount varchar(200),item_commentCount varchar(200),item_commentUrl varchar(200),item_describe varchar(200),item_imageHeight varchar(200),item_imageUrl varchar(200),item_imageWidth varchar(200),item_isBrandNew varchar(200),item_orgPrice varchar(200),item_price varchar(200),item_provcity varchar(200),item_publishTime varchar(200),item_title varchar(200),numFound varchar(200),threelevel varchar(200),threelevel_url varchar(200),totalPage varchar(200),twolevel varchar(200),twolevel_url varchar(200),user_CreditUrl varchar(200),user_Icon varchar(200),user_ItemsUrl varchar(200),user_Nick varchar(200),user_TypeId varchar(200),user_isSinaV varchar(200),user_isTaobaoWomen varchar(200),user_taobaoWomenUrl varchar(200),user_vipLevel varchar(200),user_yellowSeller varchar(200),word varchar(200))"

        
        self.dbHelper.createTable(sql)
    #测试插入
    def testInsert(self):
        sql="insert into 430xianyuopen(name,url) values(%s,%s)"
        params=("test","test")
        self.dbHelper.insert(sql,*params) #  *表示拆分元组，调用insert（*params）会重组成元组
    def testUpdate(self):
        sql="update 430xianyuopen set name=%s,url=%s where id=%s"
        params=("update","update","1")
        self.dbHelper.update(sql,*params)
    
    def testDelete(self):
        sql="delete from 430xianyuopen where id=%s"
        params=("1")
